...
('Burro',  '3', 29, 7.0, 0.23, 'kg'),
('Pavão',  '3', 30, 6.0, 0.23, 'kg'),
('Pombo',  '3', 31, 4.0, 0.23, 'kg'),
('Codorna',  '3', 32, 3.0, 0.23, 'kg'),
('Pintinho',  '3', 33, 1.0, 0.23, 'kg'),
('Carneiro',  '3', 34, 9.0, 0.23, 'kg'),
('Lhama',  '3', 35, 8.0, 0.23, 'kg'),
('Alpaca',  '3', 36, 7.0, 0.23, 'kg'),
('Javali',  '3', 37, 10.0, 0.23, 'kg'),
('Mulherengo',  '3', 38, 11.0, 0.23, 'kg'),
('Galo',  '3', 39, 3.0, 0.23, 'kg'),
('Búfalo',  '3', 40, 9.0, 0.23, 'kg'),
('Pônei',  '3', 41, 7.0, 0.23, 'kg'),
('Camelo',  '3', 42, 10.0, 0.23, 'kg'),
('Dromedário',  '3', 43, 11.0, 0.23, 'kg'),
('Iaque',  '3', 44, 12.0, 0.23, 'kg');
...
INSERT INTO AgroTrack_Colhe (Agricultor_Pessoa_N_CartaoCidadao, Duracao_colheita, Quantidade, Produto_codigo, DataColheita) VALUES
    ...
    (34567890, 2.5, 150, 26, '2024-12-01'),
    (45678901, 2.5, 60, 27, '2024-12-01'),
    (45678901, 2.5, 140, 28, '2024-12-01'),
    (56789012, 2.5, 70, 29, '2024-12-01'),
    (56789012, 2.5, 110, 30, '2024-12-01'),
