...
('2023-11-01', '2024-05-31', 'Contrato de trabalho 10', 1123, 11, 12345678),
('2022-01-01', '2024-12-31', 'Contrato de trabalho 11', 888, 12, 23456789),
('2021-05-01', '2024-06-31', 'Contrato de trabalho 12', 895, 13, 34567890),
('2024-05-01', '2024-12-31', 'Contrato de trabalho 13', 904, 14, 45678901),
('2024-01-01', '2024-07-31', 'Contrato de trabalho 14', 1095, 15, 56789012),
('2024-01-01', '2024-12-31', 'Contrato de trabalho 15', 1120, 16, 67890123),
('2024-01-01', '2024-09-31', 'Contrato de trabalho 16', 790, 17, 78901234),
('2024-01-01', '2024-10-31', 'Contrato de trabalho 17', 795, 18, 89012345),
('2024-01-01', '2024-11-31', 'Contrato de trabalho 18', 802, 19, 90123456),
...
('2024-01-01', '2024-11-31', 'Contrato de trabalho 24', 1000, 25, 66778899),
('2024-01-01', '2024-12-31', 'Contrato de trabalho 25', 1092, 26, 77889900),
('2024-01-01', '2024-11-31', 'Contrato de trabalho 26', 1120, 27, 88990011),
...
INSERT INTO AgroTrack_Encomenda (Codigo, prazo_entrega, Morada_entrega, Retalhista_Empresa_Id_Empresa, Empresa_De_Transportes_Id_Empresa, Quinta_Empresa_Id) VALUES
    (1, 2, 'Rua Principal, 250', 11, 2, 1),
    (2, 3, 'Avenida Central, 260', 12, 5, 4),
    (3, 4, 'Travessa das Utilidades, 270', 13, 5, 7),
    (4, 5, 'Rua das Novidades, 280', 14, 8, 4),
    (5, 6, 'Avenida das Mercadorias, 290', 15, 8, 7),
    (6, 7, 'Praça das Flores, 300',  11, 11,10),
    (7, 8, 'Largo do Mercado, 310', 12, 14, 10),
    (8, 9, 'Beco do Comércio, 320', 13, 14, 10),
    (9, 10, 'Estrada Velha, 330', 14, 14, 13),
    (10, 11, 'Alameda das Árvores, 340', 15, 14, 13),
    (11, 12, 'Rua do Sol, 350', 11, 17, 13),
    (12, 13, 'Avenida das Nações, 360', 12, 20, 16),
    (13, 14, 'Travessa da Esperança, 370', 13, 23, 16),
    (14, 15, 'Rua das Flores, 380', 14, 23, 16),
    (15, 16, 'Avenida do Futuro, 390', 15, 23, 16),
    (16, 17, 'Rua da Liberdade, 400', 11, 26, 19),
    (17, 18, 'Avenida dos Sonhos, 410', 12, 26, 19),
    (18, 19, 'Praça das Alegrias, 420', 13, 26, 19),
    (19, 20, 'Beco das Maravilhas, 430', 14, 26, 19),
    (20, 21, 'Largo das Estrelas, 440', 15, 29, 22),
    (21, 22, 'Rua da Paz, 450', 11, 29, 22),
    (22, 23, 'Avenida da Harmonia, 460', 12, 29, 22),
    (23, 24, 'Travessa do Amor, 470', 13, 29, 22),
    (24, 25, 'Rua dos Desejos, 480', 14, 29, 25),
    (25, 26, 'Avenida da Felicidade, 490', 15, 11, 25),
    (26, 27, 'Praça da Sabedoria, 500', 11, 11, 25),
    (27, 28, 'Largo do Conhecimento, 510', 12, 11, 28),
    (28, 29, 'Rua da Intuição, 520', 13, 2, 28),
    (29, 30, 'Avenida da Inspiração, 530', 14, 2, 28),
    (30, 31, 'Travessa da Imaginação, 540',15, 5, 28);
...
INSERT INTO AgroTrack_Compra(Produto_codigo, Cliente_Pessoa_N_CartaoCidadao, Preco, Quantidade, Metodo_de_pagamento, ID_Quinta, DataCompra) VALUES
    ...
    (2, 32165498, 12, 10, 'Cartão de Crédito', 2, '2024-05-30'),
    (3, 36985217, 10, 20, 'Dinheiro', 3, '2024-05-30'),
    (4, 65498732, 10.4, 8, 'Cartão de Débito', 4, '2024-05-30'),
    (5, 98732165, 4, 5, 'MBWay', 5, '2024-05-30'),
    (6, 18041804, 15, 15, 'Cartão de Crédito', 1, '2024-05-30'),
    (7, 36925814, 8.5, 10, 'Dinheiro', 2, '2024-05-30'),
