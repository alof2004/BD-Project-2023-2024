...
(7, 'Quinta da Primavera', 'Rua dos Lírios, 15'),
...
(11, 'Transportes Velozes LTDA', 'Rua das Rotas Rápidas, 80'),
(12, 'Logística Global', 'Avenida da Eficiência Logística, 90'),
(13, 'Entrega Segura', 'Travessa da Entrega Certa, 100'),
(14, 'Transportadora Ágil Express', 'Rua da Entrega Expressa, 110'),
(15, 'Fretes Rápidos SA', 'Avenida dos Fretes, 120'),
(16, 'Logística Integrada', 'Travessa da Logística, 130'),
(17, 'Supermercado Central', 'Rua Principal, 250'),
(18, 'Loja do Bairro', 'Avenida Central, 260'),
(19, 'Casa dos Utensílios', 'Travessa das Utilidades, 270'),
(20, 'Continente', 'Rua das Novidades, 280'),
(21, 'Armazém Geral', 'Avenida das Mercadorias, 290'),
(22, 'Loja do Comércio', 'Travessa do Comércio, 300'),
...
INSERT INTO AgroTrack_Contrato(
    ...
    '2024-01-01', -- Data de início fixa
    '2024-12-31', -- Data de fim fixa
    'Contrato Padrão', -- Descrição do contrato
    1000, -- Salário fixo
    Id_Trabalhador, -- ID do agricultor
    Pessoa_N_CartaoCidadao -- Número do cartão do cidadão do agricultor
